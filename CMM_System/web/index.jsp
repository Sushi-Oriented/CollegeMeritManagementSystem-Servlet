                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Welcome to College Merit Management System!</h1>
                        </div>
                        <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    easily modified with no need for any custom CSS!okokok jeeeokkkkooo ye ye jeee
                                </div>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
