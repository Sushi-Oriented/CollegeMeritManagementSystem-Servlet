            ...
            <ul class="navbar-nav bg-gradient-sidebar-custom sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="login.jsp">Edit Profile</a>
                        <a class="collapse-item" href="register.jsp">Logout</a>
                    </div>
                </div>
                </li>
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item">
                    <a class="nav-link" href="program.jsp">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item">
                    <a class="nav-link" href="merit.jsp">
